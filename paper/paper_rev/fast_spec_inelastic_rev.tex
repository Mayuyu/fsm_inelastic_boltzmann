...
\begin{table}[htp!]
  ...
  \begin{tabu} to 0.8\linewidth {X[1,c] X[2,c]}
    ...
    \bottomrule
  \end{tabu}
  \caption{Convergence test in $M_{\text{sph}}$ of the 3D Maxwell molecule {\color{blue} with isotropic initial} for $e=0.2$. Errors shown here are $|T_\text{num} - T_\text{ref}|$ at $t_\text{final}=1$. $\Delta t = 0.01$, $N = 32$, $N_{\rho}=30$, $R=7$, $L=7.72$.}
  \label{table 3}
\end{table}
...
\begin{table}[htp!]
  ...
  \begin{tabu} to 0.8\linewidth {X[1,c] X[2,c]}
    ...
    \bottomrule
  \end{tabu}
  \caption{Convergence test in $M_{\text{sph}}$ of the 3D Maxwell molecule {\color{blue} with isotropic initial} for $e=0.2$. Errors shown here are $|Q_\text{num} - Q_\text{direct}|_{L^{\infty}}$ at $t_\text{final}=1$. $\Delta t = 0.01$, $N = 32$, $N_{\rho}=30$, $R=7$, $L=7.72$.}
  \label{table 4}
\end{table}
